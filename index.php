              ...
              <div class="row d-flex align-items-center">
                <div class="col-md-6">
                  <div class="banner-content">
                    ...
                    <a href="product_list.php" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Product</a>
                  </div>
                </div>
                <div class="col-md-5">
      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            ...
            <div class="btn-right">
              <a href="product_list.php" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
            </div>
          </div>
          <div class="swiper product-swiper">
            <div class="swiper-wrapper">
              <?php
              $phonesql="SELECT TOP 10
                         name,
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="<?php echo$row['image_path'];?>" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="product_detail.php?product_name=<?php echo $row['name'];?>" class="btn btn-medium btn-black">View Product<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                    </div>
                  </div>
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase pe-1">
                      <a href="#"><?php echo $row['name'];?></a>
                    </h3>
                    <span class="item-price text-primary">RM <?php echo $row['price'];?></span>
                  </div>
                </div>
              </div>
              <?php
      ...
      <div class="row d-flex flex-wrap align-items-center">
        <div class="col-md-6 col-sm-12">
          <div class="text-content offset-4 padding-medium">
            ...
            <a href="product_list.php" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Sale</a>
          </div>
        </div>
        <div class="col-md-6 col-sm-12">
        ...
        <div class="row">
          ...
          <div class="d-flex flex-wrap">
            <figure class="instagram-item pe-2">
              <a href="#instagram" class="image-link position-relative">
